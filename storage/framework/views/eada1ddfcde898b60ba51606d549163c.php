...
<?php $__env->startSection('content'); ?>
    <div class="bg-white p-4 sm:p-6 rounded-md shadow-md max-w-full mx-auto flex flex-col">
        ...
        <div class="flex justify-center md:justify-end">
            <form method="GET" action="<?php echo e(route('admin.dataadmin.index')); ?>" class="flex border border-hulk focus:border-old-hulk max-w-full md:max-w-60 mb-4 rounded-full">
                <input type="text" name="search" placeholder="Cari Data Admin" value="<?php echo e(request('search')); ?>" class="pl-4 py-2 rounded-l-full focus:outline-none w-full sm:w-auto">
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full border border-hulk text-xs sm:text-sm md:text-base">
            ...
            <tbody>
                <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="px-2 sm:px-4 py-2 border border-hulk"><?php echo e($admin->id); ?></td>
                        <td class="px-2 sm:px-4 py-2 border border-hulk"><?php echo e($admin->name); ?></td>
                        <td class="px-2 sm:px-4 py-2 border border-hulk"><?php echo e($admin->email); ?></td>
                        <td class="px-2 sm:px-4 py-2 border border-hulk flex flex-col sm:flex-row sm:space-x-2">
                            <!-- Tombol Edit -->
                            <a href="<?php echo e(route('admin.dataadmin.edit', $admin->id)); ?>" class="bg-hulk text-white px-3 py-1 rounded hover:bg-old-hulk w-full sm:w-auto text-center">
                                Edit
                            </a>

                            <!-- Tombol Hapus -->
                            <button onclick="openOverlay(<?php echo e($admin->id); ?>)" class="bg-red-600 text-white px-3 py-1 rounded hover:bg-red-700 text-center">
                                Hapus
                            </button>
                            <form id="delete-form-<?php echo e($admin->id); ?>" action="<?php echo e(route('admin.dataadmin.destroy', $admin->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
        ...
        <div class="mt-4 flex justify-center sm:justify-end">
            <?php echo e($admins->appends(['search' => request('search')])->links()); ?>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\php\FinalPoject_CycleTech\resources\views/Admin/DataAdmin/index.blade.php ENDPATH**/ ?>