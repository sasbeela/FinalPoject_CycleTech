...
<body class="bg-gradient-to-b from-birumuda to-krem flex min-h-screen">
    ...
    <div class="lg:w-1/3 w-full p-8 flex flex-col justify-center relative">
        ...
        <form id="nasabahForm" class="block md:px-32 lg:px-0" action="<?php echo e(route('submit.nasabah')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
                <label for="email" class="block text-gray-700">Email</label>
                <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-old-hulk" required>
            </div>
            <div class="mb-4">
        ...
        <div class="text-center mt-4">
            <p>Belum memiliki Akun? <a href="<?php echo e(route('signin.nasabah')); ?>" class="text-hulk">Daftar</a></p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\php\FinalPoject_CycleTech\resources\views/Akun/login.blade.php ENDPATH**/ ?>