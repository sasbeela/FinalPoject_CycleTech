    ...
    <section class="bg-gradient-to-b from-white via-birumuda to-krem py-8 md:py-16">
        <div class="container mx-auto flex flex-col items-center justify-between px-4 md:px-32">
            ...
            <div class="flex justify-center space-x-4">
                <a href="<?php echo e(route('deteksi.sampah')); ?>" class="border-2 ease-in duration-150 bg-hulk border-hulk text-white py-2 px-8 rounded-3xl hover:bg-gradient-to-r from-black to-old-hulk">Mulai Deteksi!</a>
            </div>
        </div>
    </section>
                    ...
                    <a href="<?php echo e(route('detail.artikel', $article->id)); ?>" class="block">
                        <div class="bg-white shadow-lg rounded-lg overflow-hidden h-[350px] hover:shadow-xl transition-shadow duration-300">
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-gray-600 mt-2"><?php echo e(Str::limit($article->isi, 70)); ?></p>
                            </div>
                        </div>
                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
