    ...
    <nav class="bg-gradient-to-r from-birumuda to-krem shadow-lg fixed top-0 w-full h-18 z-50">
        <div class="container mx-auto flex items-center justify-between py-4 px-6 md:px-10">
            ...
            <ul class="hidden lg:flex items-center space-x-6 font-medium text-gray-700">
                ...
                <li><a href="<?php echo e(route('kelola.sampah')); ?>" class="text-white bg-green-700 rounded-lg hover:bg-old-hulk inline-flex justify-center w-full px-4 py-2">Kelola Sampah</a></li>
                <li>
    ...
    <section class="bg-white py-12 mt-12">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-center px-32">
            ...
            <div class="md:w-1/2 flex justify-center">
                <img src="<?php echo e(asset('images/kelolasampah 1.png')); ?>" alt="Hero Image" class="rounded-lg">
            </div>
        </div>
    </section>
...
<?php /**PATH C:\xampp\htdocs\php\FinalPoject_CycleTech\resources\views/KelolaSampah/kelolasampah.blade.php ENDPATH**/ ?>