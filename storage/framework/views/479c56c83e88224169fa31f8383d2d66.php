...
<body>
    ...
    <section class="bg-white py-16 px-32">
        <nav class="text-sm text-gray-600 mb-4">
                <a href="<?php echo e(route('dashboard.nasabah')); ?>" class="hover:underline">Beranda</a> > <span class="text-gray-800">Artikel</span>
            </nav>
            <header class="mb-6">
...
<?php /**PATH C:\xampp\htdocs\php\FinalPoject_CycleTech\resources\views/Dashboard/artikel.blade.php ENDPATH**/ ?>