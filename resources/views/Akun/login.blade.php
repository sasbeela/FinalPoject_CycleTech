...
<body class="bg-green-100 flex min-h-screen">
    ...
    <div class="w-1/3 p-8 flex flex-col justify-center relative">
        ...
        <form id="nasabahForm" style="display: block;" action="{{ route('submit.nasabah') }}" method="POST">
            @csrf
            <div class="mb-4">
        ...
        <div class="text-center mt-4">
            <p>Belum memiliki Akun? <a href="{{ route('signin.nasabah') }}" class="text-green-500">Daftar</a></p>
        </div>
    </div>
