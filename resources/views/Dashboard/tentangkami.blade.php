...
<body>
            ...
            <ul class="hidden lg:flex items-center space-x-6 font-medium text-gray-700">
                ...
                <li>
                    <div class="relative inline-block text-left">
                        <button id="dropdownButtonDesktop" type="button" class="text-black hover:text-old-hulk">
                            Kreasi
                        </button>
    ...
    <div class="relative bg-gray-50 py-10 px-6 md:px-10">
        <div class="relative bg-cover bg-center h-[400px] rounded-lg overflow-show">
