...
@section('content')
    ...
    <div class="bg-white p-4 sm:p-6 rounded-md shadow-md max-w-full mx-auto flex flex-col">
        ...
        <div class="flex justify-center md:justify-end">
            ...
            <form method="GET" action="{{ route('admin.datauser.index') }}" class="flex border border-hulk focus:border-old-hulk max-w-full md:max-w-60 mb-4 rounded-full">
            ...
            <tbody>
                {{-- @foreach ($nasabah as $user)
                    <tr>
                        ...
                        <td class="px-2 sm:px-4 py-2 border-hulk flex flex-col sm:flex-row sm:space-x-2">
                            <button onclick="openOverlay({{ $user->id }})" class="bg-red-600 text-white px-3 py-1 rounded hover:bg-red-700 text-center">
                                Hapus
                            </button>
